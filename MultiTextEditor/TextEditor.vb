...
Public Class frmTextEditor
    ...
    ''' <summary>
    ''' Subprocedure for Open Button - opens an existing file by searching through system directories, and once selected,
    ...
    ''' <summary>
    ''' Subprocedure for SaveAs Button - this handles events when the user clicks on the SaveAs button, within the file menu
    ''' </summary>
    ...
    ''' <summary>
    ''' Subprocedure for Close Button - this handlers events when the user clicks on the Close button and prompts the user to save their work if text has been added to an unsaved document
    ''' </summary>
    ...
    ''' <summary>
    ''' Subprocedure for Copy Button - this handles events when the user clicks on the Copy button, of triggers the button using a shortcut, which then will write the selected
    ...
    ''' <summary>
    ''' Subprocedure for Cut Button - this handles events when the user clicks on the Cut button, and removes the selected text from the textbox after writing it to the clipboard
    ''' </summary>
    Friend Sub EditCut()
